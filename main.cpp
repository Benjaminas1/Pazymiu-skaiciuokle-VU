...
int main(){
    ...
    if(confirm()){
        ...
        readFromFile(studentsFF, printMedian);
    }
    else{
        Students student;
    ...
    printResult(studentsFF, studentQuantity, printMedian, true, "rezultatai/rezultatai.txt");
    
    splitStudents(studentsFF, studentQuantity, printMedian);
